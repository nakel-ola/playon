...
// }: CardProps) {
//   const timer = useMemo(
//     () => new Timer({ interval: 7000, stopwatch: false }),
//     []
//   );
...
//     //     block: "center",
//     //   });
//     //   currentPosition = ref?.current?.offsetLeft ?? 0;
//     //   if (playing) {
//     //     timer.stop();
//     //   } else {
//     //     timer.start(7000);
...
//     //   timer.stop();
//     // }
//   }, [index, selectedIndex, timer, playing]);

//   timer.on("done", () => {
//     const element =
//       index < elements.length - 1 ? elements[index + 1] : elements[0];
//     setItem(element);
//   });
...
//     <motion.div
//       ref={ref}
//       className={`group relative w-[225px] h-[130px] border-4 m-2 rounded-xl shrink-0 overflow-hidden transition-all duration-300 hover:border-blue-700 hover:bg-blue-700 ${
//         item?.id === other?.id
//           ? "border-blue-700 bg-blue-700"
//           : "border-transparent"
//       }`}
//       onHoverStart={() => timer.status === "running" && timer.pause()}
//       onHoverEnd={() => timer.status === "paused" && timer.resume()}
//       onClick={() => {
//         setItem(other);
//         currentPosition = ref?.current?.offsetLeft ?? 0;
//       }}
//     >
//       <img
//         src={`https://image.tmdb.org/t/p/original/${other?.backdrop_path}`}
//         alt=""
//         className={`relative w-full h-full object-cover rounded-lg ${
//           index === selectedIndex ? "scale-125" : "group-hover:scale-125"
//         }`}
//       />
//       <div
//         className={`absolute top-0 left-0 w-full cursor-default h-full bg-gradient-to-r from-black/70 to-transparent ${
//           index === selectedIndex ? "flex" : "group-hover:flex hidden"
//         }`}
//       >
//         <p className="my-auto text-white pl-2 font-bold w-[40vw]">
//           {other.title ?? other.name ?? other.original_title}
//         </p>
//       </div>
//       d
//     </motion.div>
