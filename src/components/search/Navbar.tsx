...
const Navbar = ({ query }: { query: string }) => {
  ...
  return (
    <div className='flex items-center justify-between px-2 sticky top-0 z-50 bg-neutral-900'>
        <p className="text-white text-2xl md:text-3xl m-2">Result for &quot;{query}&quot;</p>
      ...
      >
        ...
        >
          ...
          <div className="flex h-full">
            ...
            <span className="h-full w-[35px] rounded-full flex items-center justify-center transition-all duration-300 hover:bg-white/10" onClick={() => router.push(`/search?q=${input}`)}>
